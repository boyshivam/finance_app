...
// Mobile Number validator
  ...
  static const mobileNumSubTextContainer = Color(0xFFE1ECFC);

  static const  mobileNumColorContainer = Color(0xFFE1ECFC);
  static const  mobileNumColorNumTextColor = Colors.black54;
  static const  mobileNumColorTextFieldBGColor = Colors.white;


  // Otp validator color
  static const otpBoxBackgroundColor = Color(0xFFFFFFFF);
  static const otpBoxDefaultStateColor = Color(0xFFE1ECFC);
  static const otpBoxActiveStateColor = Color(0xFF0461E5);
  static const otpBoxErrorStateColor = Color(0xFFEA3636);

...
class UsWalletOrdersSection extends ConsumerWidget {
  const UsWalletOrdersSection({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "US wallet related transactions will be visible here.",
          ...
          if (vmLrsTransactions.isNotEmpty)
